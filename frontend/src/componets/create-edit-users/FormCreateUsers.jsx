...
export const FormCreateUsers = () => {
      ...
      .then((data) => {
        if (data.status === 201) {
          ...
          Swal.fire({
            icon: "error",
            title: "Erro interno",
            text: "Algo deu errado ao gerar o novo usuario!",
          })
        }
      })
      .catch((error) => {
        ...
        Swal.fire({
          icon: "error",
          title: "Erro interno",
          text: "Algo deu errado durante a geração do usuario, tente novamente mais tarde",
        })
      });
  }
  ...
  return (
    <div className="card-container">
      ...
      <form style={{ margin: "1em" }} className="base-container" onSubmit={handleSubmit(onSubmit)}>
        <CreateEditUsers />
